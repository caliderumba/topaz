...
-- CHARACTER CONFIG
INITIAL_LEVEL_CAP = 5 -- The initial level cap for new players.  There seems to be a hardcap of 255.
...
DIG_ABUNDANCE_BONUS = 1 -- Increase chance of digging up an item (450  = item digup chance +45)
